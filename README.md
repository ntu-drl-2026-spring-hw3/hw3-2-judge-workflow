...
|-------|---------------|-----|------------------------|
| 0 | `SeekAndSlayLevel0-v0` | `default` | 15 |
| 1 | `SeekAndSlayLevel1_6-v0` | `mixed_enemies` | 10 |
| 2 | `SeekAndSlayLevel3_1-v0` | `blue_mixed_resized` | 8 |
| 3 | `SeekAndSlayLevel2_3-v0` | `red_mixed_enemies` | 5 |
